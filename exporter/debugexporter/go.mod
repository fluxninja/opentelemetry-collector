...
require (
	...
	github.com/fluxninja/aperture/api/v2 v2.0.0-20231228195310-b65720bf7857 // indirect
	github.com/fluxninja/aperture/v2 v2.34.1-0.20240205071947-e668f67a5023 // indirect
